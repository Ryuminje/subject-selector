        ...
        <div className="flex flex-wrap gap-1.5">
          {presets.map((preset) => (
            ...
            >
              ...
              >
                {preset.name}
                <span className="ml-1 font-normal text-stone-400">{preset.teachers.length}</span>
              </button>
              ...
              <button
                ...
                className="px-1 py-1 text-stone-300 hover:text-swap disabled:hover:text-stone-300 disabled:opacity-40"
              >
