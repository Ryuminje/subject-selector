  ...
  return (
    <main className="max-w-2xl mx-auto px-2 md:px-6 py-6 w-full">
      <Link
        ...
        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/80 hover:bg-white text-cert text-sm font-medium rounded-[10px] border border-cert/20 transition-colors mb-4"
      >
